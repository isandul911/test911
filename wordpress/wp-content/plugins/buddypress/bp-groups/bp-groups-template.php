 ...
 *                           Default: current group in loop.
 */
function bp_group_game( $group = false ) {
//	echo bp_get_group_game( $group );
	return bp_get_group_game( $group );
}
	/**
	 * Get the game of the current group in the loop.
	 *
	 * @since 1.0.0
	 *
	 * @param object|bool $group Optional. Group object.
	 ...
	 * @return string
	 */
	function bp_get_group_game( $group = false ) {
		global $groups_template;
		...
		/**
		 * Filters the game of the current group in the loop.
		 *
		 * @since 1.0.0
		 * @since 2.5.0 Added the `$group` parameter.
		 *
		 ...
		 * @param object $group Group object.
		 */
		return apply_filters( 'bp_get_group_name', $group->game, $group );
	}

function bp_group_language( $group = false ) {
//	echo bp_get_group_language( $group );
	return bp_get_group_language( $group );
}
	/**
	 * Get the game of the current group in the loop.
	 *
	 ...
	 * @return string
	 */
	function bp_get_group_language( $group = false ) {
		global $groups_template;
		 ...
		 * @param object $group Group object.
		 */
		return apply_filters( 'bp_get_group_name', $group->language, $group );
	}
 ...
 * @since 1.1.0
 */
function bp_new_group_game() {
	echo bp_get_new_group_game();
}
	 ...
	 * @return mixed|void
	 */
	function bp_get_new_group_game() {
		$bp   = buddypress();

		$game = isset( $bp->groups->current_group->game )
			? $bp->groups->current_group->game
			: '';

		/**
		 * Filters the new group game.
		 *
		 * @since 1.1.0
		 *
		 * @param string $name Game of the new group.
		 */
		return apply_filters( 'bp_get_new_group_game', $game );
	}


function bp_new_group_language() {
	echo bp_get_new_group_language();
}
	 ...
	 * @return mixed|void
	 */
	function bp_get_new_group_language() {
		$bp   = buddypress();
		$language = isset( $bp->groups->current_group->language )
			? $bp->groups->current_group->language
			: '';
		 ...
		 * @param string $name Game of the new group.
		 */
		return apply_filters( 'bp_get_new_group_language', $language );
	}
