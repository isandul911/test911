...
add_filter( 'bp_get_group_game',                'wptexturize' );
add_filter( 'bp_get_group_language',                'wptexturize' );
...
add_filter( 'bp_get_group_game',                'convert_chars' );
add_filter( 'bp_get_group_language',                'convert_chars' );
...
add_filter( 'groups_group_game_before_save',        'wp_filter_kses',        1 );
add_filter( 'groups_group_language_before_save',        'wp_filter_kses',        1 );
...
add_filter( 'bp_get_group_game',                'stripslashes' );
add_filter( 'bp_get_group_language',                'stripslashes' );
...
add_filter( 'groups_group_game_before_save',        'force_balance_tags' );
add_filter( 'groups_group_language_before_save',        'force_balance_tags' );
...
add_filter( 'groups_group_game_before_save',        'trim' );
add_filter( 'groups_group_language_before_save',        'trim' );
...
add_filter( 'bp_get_new_group_game',        'esc_attr'     );
add_filter( 'bp_get_new_group_language',        'esc_attr'     );
